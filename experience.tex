...
\entry*[2019.05 -- \ldots]
	\inEnglish{\textbf{Setapp Sp. z o.o.} --- Service Delivery Manager.
	Managing a team of software developers and helping them in operational matters.
	Ensuring the quality of the service provided by the company to the clients (software
	development and maintenance) and shaping the service to best match the client's needs.
	Maintaning day to day relationship with clients. Upselling services. Helping team members in their career
	development.
	}
	\inPolish{\textbf{Setapp Sp. z o.o.} --- Service Delivery Manager.
	Zarządzanie zespołem developerów i zapewnianie im wsparcia w zadaniach operacyjnych.
	Zapewnianie jakości usługo dostarczanych klientom przez firmę (rozwój i utrzymanie oprogramowania) i
	dopasowyanie usługi do potrzeb klienta. Utrzymywanie codziennych relacji z klientami. Upselling usług.
	Pomaganie członkom z zespołu w rozwoju zawodowym.
	}
\entry*[2016.02 -- \ldots]
...
\entry*[2016 -- \ldots]
	\textbf{QuadrantUI} --
	\inEnglish{co-founder and developer of game UI middleware based on Qt Quick
	and QML with Unreal Engine 4 integration.}
	\inPolish{współzałożyciel i developer projektu middleware do interfejsów użytkownika w
	grach wideo opartego o Qt Quick i QML wraz z integracją z Unreal Engine 4}.
	\entry* \url{https://quadrantui.com}
\entry*[2011.09 -- 2012.04]
	\inEnglish{\textbf{CLIPT - OpenCL Image Processing Toolkit} --- I'm
	co-author of small \GTK application that implements various image
	processing algorithms on GPU through OpenCL.}
	\inPolish{\textbf{CLIPT - OpenCL Image Processing Toolkit} --- współałtorstwo
	niewielkiej aplikacji w toolkicie \GTK, w której zaimplementowane zostały
	różne algorytmy przetwarzania obrazów na kartach graficznych przy użyciu OpenCL.}
	\entry* \url{https://github.com/MiKom/clipt}
\entry*[2009 -- 2012]
	\inEnglish{\textbf{Vorticity engine} --- research game engine. I co-authored
	IO subsystem, ported the engine from Visual Studio to CMake build system,
	and ported platform-dependent bits to X11.}
	\inPolish{\textbf{Silnik 3D \emph{Vorticity}} --- eksperymentalny silnik 3D.
	Jestem współautorem podsystemu IO silnika. Przeniosłem silnik
